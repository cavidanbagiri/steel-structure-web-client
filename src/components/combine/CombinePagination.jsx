...
function CombinePagination({ total, limit, offset, onPageChange }) {
  ...
  return (
    <div className="flex items-center justify-start px-5 py-3 border border-gray-200 shadow-sm flex-wrap gap-3">
...
export default React.memo(CombinePagination);