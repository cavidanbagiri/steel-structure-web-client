...
function CombineStats({ total, visibleColumnsCount, currentPage, totalPages, limit }) {
  const stats = [
    { value: total.toLocaleString(), label: 'Combined Records', color: 'border-l-indigo-500' },
...
export default React.memo(CombineStats);