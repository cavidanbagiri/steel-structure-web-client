// src/components/main/MainColumnToggle.jsx
...
function MainColumnToggle({ columns, columnVisibility, onToggle, onReset }) {
  ...
  return (
    <div className="relative flex justify-center" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-56 bg-white border border-gray-200 rounded-xl shadow-2xl z-50 py-2">
...
export default React.memo(MainColumnToggle);