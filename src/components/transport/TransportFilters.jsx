    ...
    <div className="px-2 pb-2.5">
      <div className="relative">
        ...
        <input
          ...
          value={filterValue || ''}
          onChange={(e) => onChange(e.target.value)}
          className="w-full h-8 pl-7 pr-6 bg-white border border-gray-300 rounded-sm text-xs text-gray-700 placeholder-gray-400 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-50 outline-none transition-all duration-200"
        />
        {filterValue && (
          <button
            onClick={onClear}
